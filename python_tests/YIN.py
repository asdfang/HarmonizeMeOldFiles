...
class Yin:
    def __init__(self, sampleRateInHz):
        ...
        self.analysisWindowSizeInSec = 2048.0/44100.0 # hop size of 2048
        ...
        self.hopSizeInSec = 1024.0/44100.0  # use this to make Time vector (Note: was originally .01, took too long)
        ...
        self.highestAllowedFrequencyInHz = 1600 # midi 91, the G in the 3rd octave above middle C
