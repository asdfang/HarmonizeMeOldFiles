...
ta, rate = librosa.load("test_text_files/presentation/Female_3aii/Female_3aii.wav", sr=44100)
...
with open("test_text_files/presentation/Female_3aii/Female_3aii_Labels.txt", 'r+') as f:
...
with open("test_text_files/presentation/Female_3aii/Female_3aii_aubio_onsets.txt") as f:
...
with open("test_text_files/presentation/Female_3aii/Female_3aii_aubio_MIDI_128.txt") as f:
...
axarr[1].axis([0, dur-1, 50.0, 100.0])
...
axarr[2].vlines(ground_truth_onsets, -1, np.max(midi_array), colors='g')
axarr[2].vlines(new_freqs, -1,np.max(midi_array), colors='r')
